...
pdf("../figures/4.27.pdf",width=4,height=4)
library(car)
scatterplotMatrix(D,diagonal=list(method="histogram",breaks=15),smooth=FALSE,regLine=FALSE,pch=16,var.labels=c(expression(x[1]),expression(x[2]),"t"))
dev.off()
